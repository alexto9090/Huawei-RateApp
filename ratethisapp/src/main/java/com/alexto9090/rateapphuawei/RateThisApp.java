 ...
 */
package com.alexto9090.rateapphuawei;
...
import com.alexto9090.rateapphuawei.R;
...
public class RateThisApp {
     ...
     */
    public static void init(Config config, String hauweiid) {
        sConfig = config;
        HUAWEI_APP_ID = hauweiid;
    }
    ...
    private static void showRateDialog(final Context context, AlertDialog.Builder builder) {
        ...
        builder.setPositiveButton(rateButtonID, new OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                String url = "appmarket://details?id=" + appPackage;
                ...
                try {
                    ...
                    context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://appgallery.cloud.huawei.com/marketshare/app/C" + HUAWEI_APP_ID)));
                }
                setOptOut(context, true);
            }
        });
